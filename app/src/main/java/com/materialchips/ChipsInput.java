...
import com.rultech.View.EmptyRecyclerView;
...
public class ChipsInput extends ScrollViewMaxHeight {
    ...
    private void init(AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                ...
                // others
                mAutofocus = a.getBoolean(R.styleable.ChipsInput_autoFocus, true);
            } finally {
                a.recycle();
            }
        }
    ...
    public void setHint(String mHint) {
        this.mHint = mHint;
        mChipsAdapter.setmHintLabel(this.mHint);
    }
    ...
    public ChipView createChipView() {
    ...
    public DetailedChipView createDetailedChipView(ChipInterface chip) {
